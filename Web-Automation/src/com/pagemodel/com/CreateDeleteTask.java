...
public class CreateDeleteTask {
	...
	private static void createtask()
	{
		try
		{
			opage.getprojecttaskbutton().click();
			Thread.sleep(4000);
			opage.getprojectnewtaskbutton().click();
			Thread.sleep(4000);
			opage.getprojecttaskname1().sendKeys("Rocky");
			Thread.sleep(2000);
			opage.getprojecttaskname2().sendKeys("Adheera");
			Thread.sleep(2000);
			opage.getprojecttaskname3().sendKeys("Kalashniakovv");
			Thread.sleep(2000);
			opage.getprojecttaskname4().sendKeys("rona");
			Thread.sleep(2000);
			opage.getprojecttaskname5().sendKeys("kamarottu");
			Thread.sleep(4000);
	...
	private static void deletetask()
	{
		try
		{
			opage.getprojectSELECTalltask().click();;
			Thread.sleep(4000);
			oBrowser.manage().window().maximize();
			Thread.sleep(3000);
			opage.projectDELETEselectedTask().click();
			Thread.sleep(2000);
			opage.projecttaskConfirmDelete().click();
			Thread.sleep(5000);
		}catch(Exception e)
		{
			e.printStackTrace();
