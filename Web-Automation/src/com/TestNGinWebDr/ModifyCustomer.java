...
public class ModifyCustomer {
	...
	private static void modifycustomer(String modify)
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[2]/div[2]/div[1]/div[3]/div[2]/div/div[1]/textarea")).sendKeys(modify);
			Thread.sleep(2000);
	...
	public Object[][] getmodifycustomer()
	{
		return new Object[][]
				{
			{"Collected 1500 crore worldwide and became a pan india blockbuster movie and become lifetime collected movies pof yash"}
				};
	}
}
